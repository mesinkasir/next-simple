...
function Nav() {
  return (
    <nav className="navbar p-1 fixed-top col-md-8 offset-md-2 bg-white">
      <Link className="nav-link border-bottom border-dark p-1" href={data.url1}>
        {data.menu1}
      </Link>
      <Link className="nav-link border-bottom border-dark p-1" href={data.url2}>
        {data.menu2}
      </Link>
